        ...
        <div class="grid lg:grid-cols-1 gap-4 lg:max-w-2xl">
            <form action="/blog" method="POST" enctype="multipart/form-data">
                ...
                <div class="border focus-within:border-primary focus-within:text-primary transition-all duration-500 relative rounded p-1 mb-4">
                    ...
                    <p>
                        <textarea class="py-1 px-1 outline-none block h-full w-full" name="description" cols="87" rows="10"></textarea>
                    </p>
                </div>
                <div class="border focus-within:border-primary focus-within:text-primary transition-all duration-500 relative rounded p-1 mb-4">
                    <div class="-mt-3 absolute tracking-wider px-1 uppercase text-xs">
                    ...
                    <p>
                        <input autocomplete="false" class="py-1 px-1 outline-none block h-full w-full" name="featured-image" type="file">
                    </p>
                </div>
                <div class="border focus-within:border-primary focus-within:text-primary transition-all duration-500 relative rounded p-1 mb-4">
                    <div class="-mt-3 absolute tracking-wider px-1 uppercase text-xs">
                    ...
                    <p>
                        <input autocomplete="false" tabindex="0" type="text" name="category" class="py-1 px-1 outline-none block h-full w-full">
                    </p>
                </div>
                <div class="border focus-within:border-primary focus-within:text-primary transition-all duration-500 relative rounded p-1 mb-4">
                    <div class="-mt-3 absolute tracking-wider px-1 uppercase text-xs">
